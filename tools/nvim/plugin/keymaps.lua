...
set('n', '<leader>fm', function()
  Snacks.picker.recent { filter = { cwd = true }, cmd = 'find . -type f -mmin -1440' }
end, { desc = '[F]ind [M]odified (24h)' })
set('n', '<leader>pk', function()
  Snacks.picker.keymaps()
end, { desc = '[P]review [K]eymaps' })
...
end, { desc = '[S]earch [H]istory (Regex)' })
