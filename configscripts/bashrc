...
# Show current branche in terminal
parse_git_branch() {
...
export PS1="\[\033[00m\]\u@\h\[\033[01;34m\] \W \[\033[31m\]\$(parse_git_branch)\[\033[00m\]$\[\033[00m\]\[\033[31m\]\$(parse_hg_branch)\[\033[00m\]\[\033[00m\] "


# aliases
alias ll="ls -lash --color=none"
alias cmpd="curl -s http://getcomposer.org/installer | php"
alias gl="git log --graph --decorate --oneline"

alias cmpi="composer install"
alias cmpu="composer update"
alias cmpo="composer self-update"
alias cmps="composer status"
alias ipext='curl -s http://checkip.dyndns.org/ | grep -o '[0-9][0-9]*.[0-9][0-9]*.[0-9][0-9]*.[0-9]*''
alias h='history'
alias sug="sudo apt-get install -y"
